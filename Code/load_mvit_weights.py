...
def load_mvit_weights(  weight_path: str,
    ...
    for key in old_keys:
        ...
        elif 'head.projectection' in key: new_key = key.replace('head.projectection', 'head.1')
    ...
    torch.save(model.state_dict(), './Models/mvit_SSv2/mvitv2_b_ssv2_new.pyth')